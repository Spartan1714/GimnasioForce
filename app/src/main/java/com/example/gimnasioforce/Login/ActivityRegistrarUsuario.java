package com.example.gimnasioforce.Login;
...
import com.example.gimnasioforce.R;
import com.example.gimnasioforce.RestApi;
...
public class ActivityRegistrarUsuario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtlogin = (TextView)findViewById(R.id.txtLoginn);
